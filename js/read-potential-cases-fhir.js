...
(async () => {
  ...
  await fs.writeFile("hypertension-with-end-organ-damage-elixhauser-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hypertension-with-end-organ-damage-elixhauser-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
